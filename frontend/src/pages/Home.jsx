    ...
    <div style={{ minHeight: "100vh", background: "var(--bg-primary)", overflowX: "hidden" }}>
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          ...
          <span style={{ fontFamily: "Cormorant Garamond, sans-serif", fontSize: "20px", fontWeight: 800, color: "white" }}>HabitFlow</span>
        </div>
      ...
      <section style={{
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: "900px" }}>
          ...
          <div style={{
            ...
            <span style={{ fontSize: "13px", fontWeight: 600, color: "#4ade80" }}>hellow users</span>
          </div>

          {/* Headline */}
          <h1 style={{
            fontFamily: "Cormorant Garamond, sans-serif", fontWeight: 800, lineHeight: 1.05,
          ...
          <div style={{
            ...
            {STATS.map((stat, i) => (
              <div key={i} style={{ textAlign: "center" }}>
                ...
                <div style={{
                  fontFamily: "Cormorant Garamond, sans-serif", fontSize: "28px", fontWeight: 800,
                  background: "linear-gradient(135deg, #22c55e, #4ade80)",
                  WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text",
                }}>{stat.value}</div>
      ...
      <section style={{ padding: "80px 32px", maxWidth: "1100px", margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "60px" }}>
          ...
          <h2 style={{ fontFamily: "Cormorant Garamond, sans-serif", fontSize: "clamp(32px, 5vw, 48px)", fontWeight: 800, color: "white", marginBottom: "16px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(240px, 1fr))", gap: "16px" }}>
          {FEATURES.map((f, i) => (
            ...
            >
              ...
              <h3 style={{ fontFamily: "Cormorant Garamond, sans-serif", fontSize: "16px", fontWeight: 700, color: "white", marginBottom: "8px" }}>{f.title}</h3>
      ...
      <section style={{ padding: "80px 32px", maxWidth: "1100px", margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: "60px" }}>
          ...
          <h2 style={{ fontFamily: "Cormorant Garamond, sans-serif", fontSize: "clamp(32px, 5vw, 48px)", fontWeight: 800, color: "white" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "20px" }}>
          {HOW_IT_WORKS.map((step, i) => (
            <div key={i} style={{ position: "relative" }}>
              ...
              >
                <div style={{
                  fontFamily: "Cormorant Garamond, sans-serif", fontSize: "48px", fontWeight: 800,
                ...
                <h3 style={{ fontFamily: "Cormorant Garamond, sans-serif", fontSize: "17px", fontWeight: 700, color: "white", marginBottom: "8px" }}>{step.title}</h3>
      ...
      <section style={{ padding: "80px 32px", maxWidth: "800px", margin: "0 auto", textAlign: "center" }}>
        <div style={{
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            <h2 style={{ fontFamily: "Cormorant Garamond, sans-serif", fontSize: "clamp(28px, 4vw, 42px)", fontWeight: 800, color: "white", marginBottom: "16px" }}>
      ...
      <footer style={{ padding: "40px 32px", borderTop: "1px solid rgba(255,255,255,0.06)", textAlign: "center" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", marginBottom: "16px" }}>
          ...
          <span style={{ fontFamily: "Cormorant Garamond, sans-serif", fontSize: "18px", fontWeight: 800, color: "white" }}>HabitFlow</span>
        </div>
