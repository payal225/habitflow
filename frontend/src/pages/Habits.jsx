  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex items-center justify-between">
        <h1 style={{ fontFamily: "Cormorant Garamond, sans-serif", fontSize: "26px", fontWeight: 800, color: "var(--text-primary)" }}>
          My Habits ✅
        </h1>
          ...
          <div style={{ display: "flex", gap: "10px" }}>
            {[
              ...
              <div key={i} style={{
                ...
                <div style={{ fontSize: "22px", fontWeight: 800, color: s.color, fontFamily: "Cormorant Garamond, sans-serif" }}>{s.value}</div>
