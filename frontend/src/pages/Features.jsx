    ...
    <div className="animate-fade-in" style={{ minHeight: "80vh" }}>
      ...
      <div style={{ marginBottom: "32px", position: "relative" }}>
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <h1 style={{ fontFamily: "Syne, sans-serif", fontSize: "32px", fontWeight: 800, color: "var(--text-primary)", marginBottom: "8px" }}>
        ...
        <div className="animate-slide-up" style={{ marginBottom: "24px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "16px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
              ...
              <span style={{ fontFamily: "Syne, sans-serif", fontSize: "18px", fontWeight: 700, color: "var(--text-primary)" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: "14px" }} className="stagger">
          {FEATURE_CARDS.map((feature, i) => (
            <div key={feature.id}
              ...
              <h3 style={{ fontFamily: "Syne, sans-serif", fontSize: "15px", fontWeight: 700, color: hoveredCard === feature.id ? "var(--text-primary)" : "var(--text-secondary)", marginBottom: "6px", transition: "color 0.3s" }}>{feature.label}</h3>
