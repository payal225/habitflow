    ...
    <div style={{ display: "flex", minHeight: "100vh", background: "var(--bg-primary)" }}>
      ...
      <aside style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "28px", padding: "0 8px" }}>
          ...
          <div>
            <div style={{ fontFamily: "Syne, sans-serif", fontSize: "18px", fontWeight: 800, color: "var(--text-primary)" }}>HabitFlow</div>
      ...
      <header style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          ...
          <span style={{ fontFamily: "Syne, sans-serif", fontSize: "16px", fontWeight: 800, color: "var(--text-primary)" }}>HabitFlow</span>
        </div>
