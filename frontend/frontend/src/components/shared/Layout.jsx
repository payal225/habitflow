    ...
    <div style={{ display: "flex", minHeight: "100vh", background: "var(--bg-primary)" }}>
      ...
      {!isMobile && (
        <aside style={{
          ...
          {/* Main Nav Label */}
          {!collapsed && (
            <div style={{ fontSize: "9px", fontWeight: 700, color: "var(--text-muted)", letterSpacing: "1.5px", padding: "0 14px", marginBottom: "6px", fontFamily: "var(--font-body)" }}>MAIN MENU</div>
          )}
          ...
          {/* Bottom Section */}
          <div style={{ marginTop: "auto", borderTop: "1px solid rgba(255,255,255,0.06)", paddingTop: "14px", display: "flex", flexDirection: "column", gap: "4px" }}>
      ...
      {isMobile && (
        <header style={{
          ...
          <button onClick={() => setMenuOpen(!menuOpen)} style={{ width: "36px", height: "36px", borderRadius: "10px", background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.1)", color: "var(--text-primary)", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}>
